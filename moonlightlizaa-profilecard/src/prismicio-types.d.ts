...
export interface FooterSliceDefaultPrimary {
	/**
	 * footer_text field in *Footer → Primary*
	 *
	 * - **Field Type**: Rich Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: footer.primary.footer_text
	 * - **Documentation**: https://prismic.io/docs/field#rich-text-title
	 */
	footer_text: prismic.RichTextField;

	/**
	 * footer_image field in *Footer → Primary*
	 *
	 * - **Field Type**: Image
	 * - **Placeholder**: *None*
	 * - **API ID Path**: footer.primary.footer_image
	 * - **Documentation**: https://prismic.io/docs/field#image
	 */
...
export interface HeaderSliceDefaultPrimary {
	 ...
	 * - **Field Type**: Image
	 * - **Placeholder**: *None*
	 * - **API ID Path**: header.primary.header_profile_image
	 * - **Documentation**: https://prismic.io/docs/field#image
	 */
	 ...
	 * - **Field Type**: Rich Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: header.primary.header_profile_name
	 * - **Documentation**: https://prismic.io/docs/field#rich-text-title
	 */
	 ...
	 * - **Field Type**: Link
	 * - **Placeholder**: *None*
	 * - **API ID Path**: header.primary.header_social_button
